...
set_config_variables = dict(
    ...
    folderpath_models=r"libraries/models_library/model_IB1111",  # 模型所在的文件夹
    folderpath_config=r"libraries/configs_library/config_test_IB1111",  # 配置项设置所在的文件夹
    folderpath_parameters=r"libraries/parameters_library/parameters_test_IB1111",  # 参数设置所在的文件夹
    folderpath_agents=r"libraries/agents_library/agents_test_IB1111",  # 个体众数据初始化所在的文件夹
