...
class ModelMain:
    ...
    def model_content(self, A, A_data: AgentDataCollection, para: dict, sgv: dict):
        ...
        ## node_START
        Executer.update_variableStep(self.model_finance, 'all', A, A_data, para, sgv, is_collect=True, collect=sgv['collect'])  # 更新各银行之所有变量，在第一回合开始时
        ...
        Executer.update_variableStep(self.model_finance, 'Shock_IBA_def', A, A_data, para, sgv, is_collect=True, collect=sgv['collect'])
        ...
        Executer.update_variableStep(self.model_finance, 'Shock_P_def_t', A, A_data, para, sgv, is_collect=True, collect=sgv['collect'])  # 厂商贷款违约损失冲击传导至银行内资产冲击
        ...
        Executer.update_variableStep(self.model_finance, 'Loss_exIB_def_t', A, A_data, para, sgv, is_collect=True, collect=sgv['collect'])
        ...
        Executer.update_variableStep(self.model_finance, 'Default_IB_def_s', A, A_data, para, sgv, is_collect=True, collect=sgv['collect'])  # 更新银行间违约量
        ...
        Executer.update_variableStep(self.model_finance, 'Default_D_def_s', A, A_data, para, sgv, is_collect=True, collect=sgv['collect'])  # 更新商业银行对居民存款应违约量

        A.BB.Shock_IB_def_s[A.BB.inf] = A.BB.Default_IB_def_s[A.BB.inf]  # 计算应银行内冲击传导至银行间传染冲击
        Executer.update_variableStep(self.model_finance, 'Shock_IB_def_s', A, A_data, para, sgv, is_collect=True, collect=sgv['collect'])  # 更新违约损失冲击源头变量Shock_def_s
        ...
        Executer.update_variableStep(self.model_finance, 'clear all Shock_target', A, A_data, para, sgv, is_collect=True, collect=sgv['collect'])  # 清零所有冲击目标变量 Shock_target
        Executer.update_variableStep(self.model_finance, 'clear all Shock_interbank', A, A_data, para, sgv, is_collect=True, collect=sgv['collect'])  # 清零所有银行间冲击变量 Shock_IB
        ...
        while (A.BB.inf.any() and sgv['is_continue_process']):
            ...
            Executer.update_variableStep(self.model_finance, 'Shock_IB_def', A, A_data, para, sgv, is_collect=True, collect=sgv['collect'])

            Executer.update_variableStep(self.model_finance, 'clear all Shock_source', A, A_data, para, sgv, is_collect=True, collect=sgv['collect'])  # 清零所有冲击源头变量 Shock_source
            ...
            Executer.update_variableStep(self.model_finance, 'Loss_IB_def_t', A, A_data, para, sgv, is_collect=True, collect=sgv['collect'])
            ...
            A.BB.Default_D_def_s[A.BB.inf] = np.maximum(A.BB.Loss_exIB_def_t[A.BB.inf] + A.BB.Loss_IB_def_t[A.BB.inf] - (A.BB.E_all[A.BB.inf] + A.BB.Z_IB_all[A.BB.inf]), 0)  # 商业银行对居民存款应违约量变动
            Executer.update_variableStep(self.model_finance, 'Default_D_def_s', A, A_data, para, sgv, is_collect=True, collect=sgv['collect'])

            A.BB.Shock_IB_def_s[A.BB.inf] = A.BB.Default_IB_def_s[A.BB.inf] - Default_IB_def_s_last[A.BB.inf]  # 计算银行内冲击传导至银行间传染冲击
            Executer.update_variableStep(self.model_finance, 'Shock_IB_def_s', A, A_data, para, sgv, is_collect=True, collect=sgv['collect'])

            A.BB.Shock_D_def_s[A.BB.inf] = A.BB.Default_D_def_s[A.BB.inf] - Default_D_def_s_last[A.BB.inf]  # 计算应银行内冲击传导至居民存款传染冲击
            Executer.update_variableStep(self.model_finance, 'Shock_D_def_s', A, A_data, para, sgv, is_collect=True, collect=sgv['collect'])
            ...
            Executer.update_variableStep(self.model_finance, 'Shock_IBA_def', A, A_data, para, sgv, is_collect=True, collect=sgv['collect'])  # 计算银行持有共同贷款资产违约损失冲击目标
            ...
            Executer.update_variableStep(self.model_finance, 'Shock_IBA_def', A, A_data, para, sgv, is_collect=True, collect=sgv['collect'])  # 更新银行持有共同贷款资产违约损失冲击
            ...
            Executer.update_variableStep(self.model_finance, 'IBA', A, A_data, para, sgv, is_collect=True, collect=sgv['collect'])  # 更新银行持有共同贷款资产
