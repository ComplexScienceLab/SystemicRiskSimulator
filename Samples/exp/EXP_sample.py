...
config['folderpath_realpath_simulator'] = r"../"  # 模拟器所在工程文件夹相对本实验项目根路径文件夹之相对路径
config['foldername_outputData'] = r"SystemicRiskSimulator"  # 输出数据所在工程文件夹名称
config['folderpath_realpath_outputData'] = r"../"  # 输出数据所在工程文件夹相对本实验项目根路径文件夹之相对路径
