...
set_environments_variables = dict(
    ...
    folderpath_of_entityData="SystemicRiskSimulator/models/entities_data/__init__.py",  # 手动设置实体数据文件夹路径
    modulepath_of_entityData="SystemicRiskSimulator.models.entities_data",  # 手动设置实体数据模块路径
