...
function interBank_illiquity_contagion_shock!(BB::BankCommercial, BI::BankInterbank, b::TypeState{1}, ib::TypeState{2}, para::Dict)
    ## # 流动性短缺银行间挤兑流动传染冲击
    env[:stage] = "t1 流动性短缺银行间挤兑流动传染冲击阶段"
    @test println("阶段：$(env[:stage])")
