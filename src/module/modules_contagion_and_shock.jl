...
"函数：银行外部违约损失冲击"
function exBank_insolvent_shock!(BB::BankCommercial, BI::BankInterbank, b::TypeState{1}, ib::TypeState{2}, para::Dict)
    ## # 银行外部违约损失冲击阶段
...
"函数：资不抵债银行间违约损失传染"
function interBank_insolvent_contagion!(BB::BankCommercial, BI::BankInterbank, b::TypeState{1}, ib::TypeState{2}, para::Dict)
    ## # 资不抵债银行间违约损失传染阶段
...
"函数：资不抵债银行间违约损失冲击"
function interBank_insolvent_shock!(BB::BankCommercial, BI::BankInterbank, b::TypeState{1}, ib::TypeState{2}, para::Dict)
    ## # 资不抵债银行间违约损失冲击阶段
