...
stage_exBank_insolvent_shock = StageContent(
    1, # 编号 id
...
stage_interBank_insolvent_shock = StageContent(
    2, # 编号 id
...
stage_interBank_insolvent_contagion = StageContent(
    3, # 编号 id
...
stage_exBank_illiquity_shock = StageContent(
    4, # 编号 id
...
stage_interBank_illiquity_contagion_shock = StageContent(
    5, # 编号 id
...
stage_interBank_illiquity_allocate = StageContent(
    6, # 编号 id
...
stage_interBank_illiquity_repay = StageContent(
    7, # 编号 id
...
stage_exBank_bankrupt_contagion = StageContent(
    8, # 编号 id
...
stage_bankrupt_repay_shock = StageContent(
    9, # 编号 id
...
stage_interBank_bankrupt_contagion_shock = StageContent(
    10, # 编号 id
