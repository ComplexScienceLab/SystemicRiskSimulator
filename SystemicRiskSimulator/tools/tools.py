...
class Tools:
    ...
    def set_foldername_experiments(cls, foldername_prefix_experiments: str, foldername_set_manually: str, is_datetime: bool, type_of_experiments_foldername: str):
        ...
        Args:
            ...
            foldername_set_manually (str): 手动设置生成的实验文件夹全名。用于 `type_of_experiments_foldername=r"manually"`；
            is_datetime (bool): 是否使用日期时间字符串。默认True；
            type_of_experiments_foldername (str): 实验文件夹名称类型。取值："default"、"manually"。默认"default"；
        ...
        elif type_of_experiments_foldername == "manually":
