...
from SystemicRiskSimulator import np, Union, Any, Optional
...
# AttributeComponentType = np.dtype({'names': ['id', 'entity_name', 'text_name', 'content_type'], 'formats': ['i4', 'U', 'U', 'U']}) #TODO 无用可以删除
# AttributeComponentType = Union[np.dtype({'names': ['id', 'entity_name', 'text_name', 'content_type'], 'formats': ['i4', 'U', 'U', 'U']}),dict, str, None] #TODO 无用可以删除
