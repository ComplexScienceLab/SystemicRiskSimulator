...
- [ ] (@[[2021-12-18]]) 增加以前用思维导图做的文献笔记。


- [ ] 还有一类近来备受关注的方法，即将金融系统建模为一个复杂系统。这些研究主要关注于系统复杂度，互联性，非线性，多样性和不确定性(如 Homrmes 2006, 2008. 2009，Honmes and Wagener, 2009; LeBaron and Tesfatsion, 2008）。而且这些模型都是基于有限理性的异质性代理人，且其学习过程影响系统的整体动态过程。
