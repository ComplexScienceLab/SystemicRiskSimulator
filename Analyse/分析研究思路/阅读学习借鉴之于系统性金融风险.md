...
银行风险传染方面的Python代码：
[BoucheDimitri写的SystemicRisk](https://github.com/BoucheDimitri/SystemicRisk)。对应paper[[Bouche_Kempf_et-al_Crisis and contagion in financial networks - a dynamic approach.pdf]]。[Zotero item link](zotero://select/library/items/KMKEGRKS)
...
- [x] (@[[2021-11-10]]) 导师说的文献Zheng Song Showbank American Economics Review找不到怎么办？师妹师兄能否找得到？

- [ ] (@[[2021-12-03]]) 增加以前用思维导图做的文献笔记。


- [ ] (@2021-12-04) 还有一类近来备受关注的方法，即将金融系统建模为一个复杂系统。这些研究主要关注于系统复杂度，互联性，非线性，多样性和不确定性(如 Homrmes 2006, 2008. 2009，Honmes and Wagener, 2009; LeBaron and Tesfatsion, 2008）。而且这些模型都是基于有限理性的异质性代理人，且其学习过程影响系统的整体动态过程。


- [ ] (@[[2021-11-27]])  [马勇, 付莉, 姜伊晴, 2021. 金融冲击与中央银行的流动性支持政策研究[J]. 统计研究, 38(04): 58–73.](zotero://select/library/items/MIA876VD)
	- 里面有一些关于央行政策工具可以借鉴；
