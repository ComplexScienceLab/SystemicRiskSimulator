...
将我国银行同业交易商分为四大类，根据[[(Allen等, 2000)]]的研究建立了包括四类交易商的网络结构，采用压力测试的方法对我国银行间同业市场上分类交易商之间的流动性和风险传染效应进行了研究。
发现：
...
- [[(Allen等, 2000)]]的研究的四种代表性的银行间市场网络的结构的机理
