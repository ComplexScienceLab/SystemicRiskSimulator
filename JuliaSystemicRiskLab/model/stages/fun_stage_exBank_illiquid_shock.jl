...
"函数：银行外部挤兑流动冲击阶段"
function stage_exBank_illiquid_shock!(BB::BankCommercial, BI::BankInterbank, b::TypeState{1}, ib::TypeState{2}, para::Dict, env::Dict) #= BB_t1::BankCommercial, BI_t1::BankInterbank,  =#
    ## # 银行外部挤兑流动冲击阶段
