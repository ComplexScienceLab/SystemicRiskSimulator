...
"函数：流动性短缺银行间挤兑流动传染冲击阶段"
function stage_interBank_illiquid_contagion_shock!(BB::BankCommercial, BI::BankInterbank, b::TypeState{1}, ib::TypeState{2}, para::Dict,env::Dict)
    ## # 流动性短缺银行间挤兑流动传染冲击
    ...
    update_B_state!(BB, BI; target = "illiquid", source = "healthy")
