...
mutable struct BankCommercial{NDIMS1,NDIMS2}
    ...
    ilq::TypeState{NDIMS2} # 示性向量之于银行是否流动性短缺 isIlliquid
    ...
    listOfIlliquid::TypeList{Any} # 列表之于流动性短缺的银行编号 listOfIlliquid
...
mutable struct BankInterbank{NDIMS2}
    ...
    ilq::TypeState{NDIMS2} # 信息邻接矩阵之于银行间流动性短缺的 isIlliquid
    ...
    cre_ilq::TypeList{Any} # 信息列表之于流动性短缺的银行之债权方银行编号 listOfCreditorsInIlliquid
    deb_ilq::TypeList{Any} # 信息列表之于流动性短缺的银行之债务方银行编号 listOfDebtorsInIlliquid
