...
class Shock:
    ...
    def clear_Shock_BI_and_exBI(self, bank:BankCommercial, interbank:BankInterbank, bankState:TypeState, interbankState:TypeState):
        ...
        interbank.Shock_BI_def = np.zeros(self, env['num_bank'],env['num_bank'])
    ...
    """
    def update_B_Shock(self, bank:BankCommercial, interbank:BankInterbank, bankState:TypeState, interbankState:TypeState; byWay:String = "all"):
        if byWay == "all":
            ...
            together_Shock_BI_run_source(bank, TypeState(bank.on | bank.off))
            together_Shock_BI_source(bank, TypeState(bank.on | bank.off))
            together_Shock_exBI_source(bank, TypeState(bank.on | bank.off))
            together_Shock_source(bank, TypeState(bank.on | bank.off))
            together_Shock_def_source(bank, TypeState(bank.on | bank.off))
            together_Shock_run_source(bank, TypeState(bank.on | bank.off))
            together_Shock_BI_run(interbank, TypeState((bank.on | bank.off) & (bank.on | bank.off)'))
            together_Shock_BI(interbank, TypeState((bank.on | bank.off) & (bank.on | bank.off)'))
            sum_Shock_BI_def_target(bank, interbank, TypeState(bank.on | bank.off), TypeState((bank.on | bank.off) & (bank.on | bank.off)'))
            sum_Shock_BI_run_ilq_target(bank, interbank, TypeState(bank.on | bank.off), TypeState((bank.on | bank.off) & (bank.on | bank.off)'))
            sum_Shock_BI_run_br_target(bank, interbank, TypeState(bank.on | bank.off), TypeState((bank.on | bank.off) & (bank.on | bank.off)'))
            together_Shock_BI_run_target(bank, TypeState(bank.on | bank.off))
            together_Shock_BI_target(bank, TypeState(bank.on | bank.off))
            together_Shock_exBI_target(bank, TypeState(bank.on | bank.off))
            together_Shock_target(bank, TypeState(bank.on | bank.off))
            together_Shock_def_target(bank, TypeState(bank.on | bank.off))
            together_Shock_run_target(bank, TypeState(bank.on | bank.off))
        elif byWay == "clear Shock_B_A and Shock_B_Z":
            clear_Shock_inB(bank)
            together_Shock_B(bank, TypeState(bank.on | bank.off))
