...
class ModelBuilder:
    ...
    def build_stage(self, self, stage_content: StageContent):
        ## 获得阶段类型
    ...
    def buildProcess(self, self, process_content: ProcessContent, processSkeleton=fun_process_skeleton):
        ## 获得过程类型
    ...
    def buildModel(self, self, modelContent: ModelContent, modelSkeleton=fun_model_skeleton):
