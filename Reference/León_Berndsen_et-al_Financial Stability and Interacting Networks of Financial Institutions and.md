...
耦合金融机构的多路复用（即多层）和金融市场基础设施的单层网络的交互网络提供了金融系统真实连接架构的准确图景。我们检查并比较了哥伦比亚多元和互动金融网络的主要属性。将金融机构的多重网络与金融市场基础设施的网络相结合，消除了模块化，这增加了金融的不稳定性，因为网络无法隔离反馈并限制级联，同时保留其强大而脆弱的特性。此外，我们的分析强调了与基础设施相关的系统性风险的相关性，对应于 FMI 运行不当或 FMI 作为传染渠道造成的影响。
