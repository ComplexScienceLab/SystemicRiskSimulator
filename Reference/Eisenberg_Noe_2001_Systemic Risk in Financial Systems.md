...
* DOI: [10.1287/mnsc.47.2.236.9835](10.1287/mnsc.47.2.236.9835)
* Cite key: Eisenberg_2001_SystemicRiskinFinancialSystems
* Topics: [[博士毕业论文开题报告]], [[课程论文]], [[系统性风险 数理分析]], [[系统性风险 信用风险]]
* Related: 
...
 我们首先通过固定点定理证明，总是存在一个清算支付向量，用以清算清算系统成员的义务。在正则条件下，此清除向量存在且唯一。  
  接下来，我们开发一种算法，该算法既可以以有效的计算方式清算金融系统，又可以提供有关系统各个单个机构所面临的系统风险的信息。  
 最后，定性分析金融系的比较稳态。  
