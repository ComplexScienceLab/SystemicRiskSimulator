...
* Publication: [[arXiv:1801.02091 [q-fin]]]
* Cite key: Banerjee_2018_DynamicClearingandContagioninFinancialNetworks
* Topics: [[系统性风险 随机最优控制方法]], [[博士毕业论文开题报告]], [[随机控制应用]]
* Related: 
* Tags: [[Zotero Import]], [[Systemic Risk]], [[Quantitative Finance - Mathematical Finance]], [[Quantitative Finance - Risk Management]], [[Dynamic Network]], [[FInancial Contagion]], [[FInancial Network]]
* PDF Attachments: [Banerjee et al_2018_Dynamic Clearing and Contagion in Financial Networks.pdf](zotero://open-pdf/library/items/Y47FHHNL)

## Abstract

 In this paper we will consider a generalized extension of the Eisenberg-Noe model of ﬁnancial contagion to allow for time dynamics in both discrete and continuous time. Derivation and interpretation of the ﬁnancial implications will be provided. Emphasis will be placed on the continuous-time framework and its formulation as a diﬀerential equation driven by the operating cash ﬂows. Mathematical results on existence and uniqueness of ﬁrm wealths under the discrete and continuous-time models will be provided. Finally, the ﬁnancial implications of time dynamics will be considered. The focus will be on how the dynamic clearing solutions diﬀer from those of the static Eisenberg-Noe model.
...
- [ ]  (@2021-11-26) #today 迁移模型描述，从Xmind。
...
### 扩展文献[14]的存在性、唯一性的结果于离散时间

- 定理3.3：清算财富的唯一性

  - 备注3.4
  - 推论3.5：扩展到概率空间，清算财富的唯一性

- 算法3.6：虚拟违约算法，其基于定理3.3，以寻找清算财富过程。算法基于[14]
...
- 【14】求解微分系统【12】，推断连续时间清算财富应满足固定点问题

  - 满足条件
  - 名义债务矩阵
  - 外部资金流入

- 定义5.1：k阶违约，于静态Eisenberg-Noe设置
- 命题5.2
- 例子5.3
