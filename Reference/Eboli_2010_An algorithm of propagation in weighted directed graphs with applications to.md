...
* DOI: [10.1002/int.20399](10.1002/int.20399)
* Cite key: Eboli_2010_Analgorithmofpropagationinweighteddirectedgraphswithapplicationstoeconomicsandfinance
* Topics: [[博士毕业论文开题报告]], [[系统性风险 复杂网络仿真]], [[课程论文]]
* Related: 
* Tags: [[Zotero Import]], [[Conversation System]], [[Discourse]], [[Emotion]], [[Emotion Model]]
* PDF Attachments: [Eboli_2010_An algorithm of propagation in weighted directed graphs with applications to.pdf](zotero://open-pdf/library/items/98QV5M6V)
...
本文提出了一种计算经济主体网络中事件和动作扩散的算法，该算法适用于此类网络可以表示为加权有向图的情况。该算法的功能显示在三个应用程序中。首先，该算法被应用于由代理人模仿邻居行为驱动的创新扩散模型。其次，引入了金融网络的图论模型，并使用相应的算法来计算所谓的多米诺骨牌效应，即由一个或多个代理的初始违约引起的损失和破产的扩散。最后，将该算法应用于银行间流动性网络操作的存款转移。
