...
class BalanceSheet:
    ...
    # @classmethod
    # def update_B_balance_sheet(cls, bank: BankCommercial, interbank: BankInterbank, bankState: StateType, interbankState: StateType, by_way: str):
    #     """
    #     更新各银行之资产负债表变量。
    #
    #     参数``by_way``之可选项：
