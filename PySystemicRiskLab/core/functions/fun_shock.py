...
class Shock:
    ...
    # "汇总综合外生冲击。" #HACK无用
    # functions together_Shock_exBI(bank: pd.Series, bankState:StateType)
    ...
    @classmethod
    def clear_Shock_inB(cls, bank: pd.Series):
        """清零本回合中期所有不必要的冲击变量"""
    ...
    @classmethod
    def update_B_Shock(cls, bank: pd.Series, interbank: pd.Series, bankState, interbankState, by_way: str = "all"):
        """
        更新各银行之冲击。
