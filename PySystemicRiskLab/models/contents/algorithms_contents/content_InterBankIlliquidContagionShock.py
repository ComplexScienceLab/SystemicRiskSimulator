...
def content_InterBankIlliquidContagionShock(BB: BankCommercial, BI: BankInterbank, b: StateType, ib: StateType, para: dict, env: dict):
    ## # 流动性短缺银行间挤兑流动传染冲击
    ...
    Shock.update_B_Shock(BB, BI, b, ib, by_way='Shock_BI_run_ilq_s')  # 更新挤兑流动冲击源头变量Shock_run_t
    ...
    # update_B_Shock(BB, BI, b, ib, by_way = "Shock_BI_run_ilq_s") # 汇总各银行之流动性短缺流动性挤兑冲击
    ...
    #     pass
    # update_B_Shock(BB, BI, b, ib, by_way = "Shock_BI_run_ilq") # 加总各单个债务银行遭受总银行间挤兑流动冲击
    # update_B_state(BB, BI, target='illiquid', source='healthy') # 更新各银行之状态，从健康到流动性短缺
