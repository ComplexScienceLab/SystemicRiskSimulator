...
def content_ExBankIlliquidShock(BB: BankCommercial, IB: BankInterbank, b: StateType, ib: StateType, para: dict, env: dict):  # = BB_t1:BankCommercial, IB_t1:BankInterbank,  =#:
    ## # 银行存款挤兑流动冲击算法
    ...
    BankState.update_states(way='healthy')  # 更新各银行之状态，从健康到流动性短缺
    # BankState.update_B_state(BB, IB, target='illiquid', source='healthy')  # 更新各银行之状态，从健康到流动性短缺
