...
# from PySystemicRiskLab.core import np, TypeState, BankInterbank, BankCommercial, BankState, Shock, BalanceSheet
pass  # end import
...
"函数：银行外部违约损失冲击阶段 stage_exBank_insolvent_shock"


def stage_exBank_insolvent_shock(BB: BankCommercial, BI: BankInterbank, b: TypeState, ib: TypeState, para: dict, env: dict):
    ## # 银行外部违约损失冲击阶段
