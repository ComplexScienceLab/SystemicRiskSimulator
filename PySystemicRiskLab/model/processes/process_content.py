...
processContent_exBank_insolvent = ProcessContent(
    id=1,  # 编号 id
    function_name='process_exBank_insolvent',  # 函数名称 functionName
    text_name="银行外部违约损失传染冲击过程",  # 文本名称 textName
...
processContent_interBank_insolvent = ProcessContent(
    id=2,  # 编号 id
    function_name='process_interBank_insolvent',  # 函数名称 functionName
    text_name="资不抵债银行间违约损失传染冲击过程",  # 文本名称 textName
...
processContent_exBank_illiquity = ProcessContent(
    id=3,  # 编号 id
    function_name='process_exBank_illiquity',  # 函数名称 functionName
    text_name="银行外部挤兑流动传染冲击过程",  # 文本名称 textName
    # '(BB.Shock_t == BB_Shock_t_t1)' # 判断条件用以结束过程 conditionToContinueProcess
    list_stage_content=[
...
processContent_interBank_illiquity = ProcessContent(
    id=4,  # 编号 id
    function_name='process_interBank_illiquity',  # 函数名称 functionName
    text_name="流动性短缺银行间挤兑流动传染冲击过程",  # 文本名称 textName
    # '(BB.Shock_t == BB_Shock_t_t1)' # 判断条件用以结束过程 conditionToContinueProcess
    list_stage_content=[
...
#    id= 5, # 编号 id,
#    function_name= 'process_exBank_bankrupt', # 函数名称 functionName
#    text_name= "外生破产银行间挤兑流动传染冲击过程", # 文本名称 textName
...
processContent_interBank_bankrupt = ProcessContent(
    id=6,  # 编号 id
    function_name='process_exBank_bankrupt',  # 函数名称 functionName
    text_name="破产银行间挤兑流动传染冲击过程",  # 文本名称 textName
    # '(BB.Shock_t == BB_Shock_t_t1)' # 判断条件用以结束过程 conditionToContinueProcess
    list_stage_content=[
