...
$$
\begin{align}
Shock_{BI,run}[:,i,t_{1}] =& Shock_{BI,D}[:,i,\tau_{1}] \notag \\
=& \begin{cases}
...
=& Z_{BI}[i_{isv},j_{cre},t_{1}] - Z_{BI}[i_{isv},j_{cre},t_{1}]\; \dfrac{Shock_{BI}[:,i_{isv},t_{2}]}{Z_{B}[i_{isv},t_{1}]}
